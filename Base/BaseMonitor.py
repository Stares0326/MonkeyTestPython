...
def get_pid(pkg_name, devices):
    cmd = "adb -s " + devices + " shell ps -A | findstr " + pkg_name
    print("----get_pid-------")
    print(cmd)
...
if __name__ == '__main__':
    ...
    # cpu_rate("3844")
    pid = get_pid("com.jingdong.app.mall", "JQYNW19327002820")
    print(pid)
    # get_flow(pid, "wifi", "DU2TAN15AJ049163")
    # get_battery("DU2TAN15AJ049163")
    # get_men("com.jianshu.haruki", "DU2TAN15AJ049163")
    # print(get_cpu_kel())
    # cpu_kel = get_cpu_kel("JQYNW19327002820")
    # cpu_rate("3844",cpu_kel,"JQYNW19327002820")
